...
yystate(76, [10|Ics], Line, Tlen, _, _) ->
    yystate(68, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(76, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 36 ->
    yystate(76, Ics, Line, Tlen+1, 18, Tlen);
yystate(76, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(76, Ics, Line, Tlen+1, 18, Tlen);
...
yystate(74, Ics, Line, Tlen, _, _) ->
    {13,Tlen,Ics,Line};
yystate(73, [48|Ics], Line, Tlen, _, _) ->
...
yystate(73, Ics, Line, Tlen, _, _) ->
    {10,Tlen,Ics,Line,73};
yystate(72, [124|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [108|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [91|Ics], Line, Tlen, Action, Alen) ->
    yystate(75, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [84|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [64|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 99 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 107 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 109, C =< 113 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(71, [95|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(71, [83|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line, Tlen+1, 7, Tlen);
yystate(71, [46|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(71, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(71, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 82 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(71, [C|Ics], Line, Tlen, _, _) when C >= 84, C =< 90 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(70, Ics, Line, Tlen, _, _) ->
    {16,Tlen,Ics,Line,70};
yystate(69, [118|Ics], Line, Tlen, _, _) ->
...
yystate(69, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(69, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 117 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(69, [C|Ics], Line, Tlen, _, _) when C >= 119, C =< 122 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(68, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(68, Ics, Line, Tlen+1, 18, Tlen);
...
yystate(67, [33|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(67, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 47 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(67, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(67, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 91 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(63, [95|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(63, [76|Ics], Line, Tlen, _, _) ->
    yystate(71, Ics, Line, Tlen+1, 7, Tlen);
yystate(63, [46|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 75 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 77, C =< 90 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(62, [61|Ics], Line, Tlen, _, _) ->
    yystate(60, Ics, Line, Tlen+1, 1, Tlen);
yystate(62, [60|Ics], Line, Tlen, _, _) ->
...
yystate(59, [33|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(59, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 45 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(59, [C|Ics], Line, Tlen, Action, Alen) when C >= 47, C =< 58 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(59, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(59, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 91 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(55, [95|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(55, [65|Ics], Line, Tlen, _, _) ->
    yystate(63, Ics, Line, Tlen+1, 7, Tlen);
yystate(55, [46|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 66, C =< 90 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(52, Ics, Line, Tlen, _, _) ->
    {1,Tlen,Ics,Line,52};
yystate(51, [126|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(51, [95|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(51, [93|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(51, [33|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(51, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 47 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(51, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(51, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(51, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 91 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 33, C =< 45 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 47, C =< 59 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 61 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
...
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 45 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 47 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(44, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,44};
yystate(43, [126|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(43, [39|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [37|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(43, [33|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 58 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 91 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(43, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,43};
yystate(42, [78|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(42, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,42};
yystate(41, [119|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(41, [100|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line, Tlen+1, 10, Tlen);
yystate(41, [48|Ics], Line, Tlen, _, _) ->
    yystate(49, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 59 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 63 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(36, Ics, Line, Tlen, _, _) ->
    {8,Tlen,Ics,Line,36};
yystate(35, [51|Ics], Line, Tlen, Action, Alen) ->
...
yystate(31, Ics, Line, Tlen, _, _) ->
    {7,Tlen,Ics,Line,31};
yystate(30, [62|Ics], Line, Tlen, Action, Alen) ->
...
yystate(29, [85|Ics], Line, Tlen, Action, Alen) ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
...
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 45 ->
    yystate(44, Ics, Line, Tlen+1, 19, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 47 ->
    yystate(44, Ics, Line, Tlen+1, 19, Tlen);
...
yystate(20, [10|Ics], Line, Tlen, _, _) ->
    yystate(68, Ics, Line+1, Tlen+1, 17, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 36 ->
    yystate(20, Ics, Line, Tlen+1, 17, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(20, Ics, Line, Tlen+1, 17, Tlen);
...
yystate(18, [115|Ics], Line, Tlen, Action, Alen) ->
...
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 61 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 63 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 99, C =< 122 ->
    yystate(32, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(12, [33|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 58 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 91 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, [76|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 61 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 63 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(1, [62|Ics], Line, Tlen, Action, Alen) ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [10|Ics], Line, Tlen, Action, Alen) ->
    yystate(9, Ics, Line+1, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 61 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 63 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
