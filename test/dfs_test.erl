   ...
   Expected =
      {[{{<<"s7read">>,2},
         ...
         {{<<"change_detect">>,8},
            [],
            [{<<"timeout">>,[{duration,<<"30s">>}]}]},
         {{<<"union">>,9},[{connect,{<<"change_detect">>,8}}],[]},
         {{<<"set">>,10},
            [],
            ...
            [{<<"table">>,[{string,<<"tec_kdrerr">>}]},
               ...
               {<<"faxe_fields">>,
                  [{string,<<"id">>},
                     {string,<<"df">>},
                     {string,<<"data">>}]}]}],
         [{{<<"http_post_crate">>,14},{<<"mqtt_publish">>,13}},
            {{<<"mqtt_publish">>,13},{<<"set">>,10}},
            {{<<"crate_out">>,12},{<<"batch">>,11}},
            {{<<"batch">>,11},{<<"set">>,10}},
            {{<<"set">>,10},{<<"union">>,9}},
            {{<<"union">>,9},{<<"change_detect">>,4}},
            {{<<"change_detect">>,8},{<<"s7read">>,7}},
            {{<<"s7read">>,7},{<<"s7read">>,6}},
            {{<<"s7read">>,6},{<<"where">>,5}},
            {{<<"where">>,5},{<<"s7read">>,2}},
            {{<<"change_detect">>,4},{<<"where">>,3}},
            {{<<"where">>,3},{<<"s7read">>,2}}]},
